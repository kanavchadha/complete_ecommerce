...
const PlaceOrderScreen = (props)=>{
  ...
  const placeOrderHandler = () => {
    ...
    message.success('You are just one step away from placing Order! Go for Checkout.');
  }
  

  return <div>
    <CheckoutSteps curr={3} ></CheckoutSteps>
    <div className="placeorder">
      ...
      <div className="placeorder-action">
        <ul>
          ...
          <li>
            <div>Shipping</div>
            <div>${shippingPrice && shippingPrice.toFixed(2)}</div>
          </li>
          <li>
            <div>Tax</div>
